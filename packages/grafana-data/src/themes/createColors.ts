...
export class WideSkyColors implements ThemeColorsBase<Partial<ThemeRichColor>> {
  mode: ThemeColorsMode = CustomColors.wideSkyTheme!.basedOff;
  ...
  constructor(base: ThemeColorsBase<Partial<ThemeRichColor>>) {
    this.background = Object.assign({}, base.background, this.background);
    this.gradients = Object.assign({}, base.gradients, this.gradients);
    this.primary = Object.assign({}, base.primary, this.primary);
    this.secondary = Object.assign({}, base.secondary, this.secondary);
    this.info = Object.assign({}, base.info, this.info);
    this.error = Object.assign({}, base.error, this.error);
    this.success = Object.assign({}, base.success, this.success);
    this.warning = Object.assign({}, base.warning, this.warning);
    this.text = Object.assign({}, base.text, this.text);
    this.border = Object.assign({}, base.border, this.border);
    this.action = Object.assign({}, base.action, this.action);
  }
