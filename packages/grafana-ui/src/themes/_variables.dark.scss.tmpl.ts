...
// gradients
$brand-gradient-horizontal: linear-gradient(to right, rgb(78, 158, 215) 30%, rgb(0, 115, 188) 99%);
$brand-gradient-vertical: linear-gradient(rgb(78, 158, 215) 30%, rgb(0, 115, 188) 99%);
