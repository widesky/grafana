...
<<<<<<< HEAD:docs/sources/enterprise/configure-saml.md
...
1. In the `[auth.saml]` section in the Grafana configuration file, set [`enabled`]({{< relref "../../configure-grafana/enterprise-configuration/#enabled" >}}) to `true`.
   > > > > > > > a568d421f8 (Docs: Setup refactor (#49739)):docs/sources/setup-grafana/configure-security/configure-authentication/saml.md
